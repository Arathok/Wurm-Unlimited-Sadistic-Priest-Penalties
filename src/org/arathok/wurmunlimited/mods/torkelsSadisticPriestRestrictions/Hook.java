    ...
    public static void skillReset(Player aPlayer) {
        try {
            ...
            if (deityNum==1)
            {
                ...
                aPlayer.getSkills().getSkill(10070).setKnowledge(1.0001,false); // Warhammer
                aPlayer.getSkills().getSkill(1027).setKnowledge(1.0001,false); // Hammers
                aPlayer.getSkills().getSkill(10058).setKnowledge(1.0001,false); // Shieldbash
                ...
                aPlayer.getSkills().getSkill(10028).setKnowledge(1.0001,false); // 2HSwords
           ...
           if (deityNum==101||deityNum==105||deityNum==107) // Hawkeye, Silverranger, Phantomranger
           {
               ...
               aPlayer.getSkills().getSkill(10058).setKnowledge(1.0001,false); // Shieldbash
               aPlayer.getSkills().getSkill(10047).setKnowledge(1.0001,false); // Scythe
